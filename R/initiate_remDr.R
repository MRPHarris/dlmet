#' Initialise and terminate an RSelenium remote server with Chrome
#'
#' Start up and then immediately terminate a remote server with RSelenium. This
#' will check to confirm everything is working properly.
#'
#' @param verbose generate query window prior to running.
#' @param chromepath directory of google chrome install.
#'
#' @export
initiate_remDr <- function(verbose = TRUE, chromepath = 'C:/Program Files/Google/Chrome/Application/'){
  if(isTRUE(verbose)){
