...
Note: currently **dlmet** is only tested for Windows. It could work on Mac, but likely requires the user to jump through a few [extra hoops](https://stackoverflow.com/questions/50880725/rselenium-installation-on-macbook-with-chrome) to get RSelenium working. 
